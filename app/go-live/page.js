...
export default async function GoLivePage(){
  ...
  return <main className={styles.page}>
    ...
    <section className={styles.hero}>
      ...
      <div className={styles.score}><span>PRE-REQUISITES</span><b>{readiness.prerequisitesReady?"READY":"STAGED"}</b><small>{readiness.liveReady?"live gate approved":"real-data gate remains closed"}</small><Link className={styles.back} href="/activation">Open activation audit <ChevronRight size={12}/></Link></div>
    </section>
