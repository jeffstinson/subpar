...
import { CheckCircle2, ClipboardCopy, ExternalLink, Link2, Search, ShieldCheck, TriangleAlert, UserRound, Wrench } from "lucide-react";
    ...
    <section className={styles.detail}>
      {!active?<div className={styles.empty}><UserRound size={25}/><b>No intake selected</b></div>:<>
        ...
        <div className={styles.cards}>
          ...
          <article><span>COMPATIBILITY</span><b>{active.compatibilityStatus||"pending"}</b><small>{active.compatibilityNotes||"Doug has not reviewed this intake yet."}</small></article>
        </div>
