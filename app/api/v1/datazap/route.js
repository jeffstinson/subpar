...
import { registerDatazapReference } from "../../../server/datazap-reference";
...
export async function POST(request){
  try{
    ...
    const data=await registerDatazapReference({projectNumber:body.project,url:body.url,revisionId:body.revisionId||null,actor:auth.principal.displayName||auth.principal.email||"Subpar tuner"});
