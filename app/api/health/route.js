...
export async function GET(){
  try {
    ...
    return Response.json({
      ...
      schemaHead:readiness.schemaHead,
      ...
      activation:{
        center:"/activation",
        auditApi:"/api/v1/activation/audit",
        checkpointApi:"/api/v1/activation/checkpoint",
        schemaHead:readiness.schemaHead,
        integrityAuditMode:system.configuredMode==="supabase"?"available-after-0015":"staged",
        productionActivation:"guarded-zero-blocker-checkpoint",
      },
