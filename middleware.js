...
const internalPrefixes=["/project","/workspace","/intake","/intake-queue","/intelligence","/log-lab","/log-review","/reviews","/revision","/closeout","/automations","/security","/persistence","/data-core","/mobile","/files","/integration-lab","/go-live","/messages","/outbound"];
